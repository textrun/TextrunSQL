...
This changelog covers downstream changes only and uses `YYYY.MM.DD` headings instead of assigning TextrunSQL a separate semantic version. The release baseline remains the corresponding SQLCipher version. SQLCipher and SQLite history remains in the inherited upstream changelogs.
